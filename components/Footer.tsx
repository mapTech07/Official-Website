...
import company__logo from '../public/footer_Site_Logo.webp';
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-10">
          ...
          <section className="md:col-span-3">
            ...
            <p className="text-gray-300 mb-8 -mt-1">
              We aim to transform businesses and government systems through
              cutting-edge technology and tailored services
            </p>
            <div>
              <h5 className="font-semibold text-xl mb-2">Get in touch</h5>
              <p className="text-sm text-gray-300">
                Mon-Fri during NP working hours
              </p>
            </div>
          </section>

          {/* Navigation Section - 3 columns - Hidden on mobile */}
          <section className="hidden md:block md:col-span-3 md:ml-8 mt-1">
            ...
            <ul className="space-y-3">
              {menu.map(({ title, to_path }, index) => (
                <li key={index}>
                  <Link
                    href={to_path}
                    className="hover:text-[#0066CC] text-base transition-colors"
                  >
                    {title}
                  </Link>
                </li>
          ...
          <section className="md:col-span-3 mt-1">
            ...
            <div className="flex gap-6 mb-6">
              <Link
                href="https://www.facebook.com/maptechnepal/"
                target="_blank"
                aria-label="Facebook"
              >
              ...
              <Link
                href="https://linktr.ee/maptechnepal"
                target="_blank"
                aria-label="Linktree"
              >
            ...
            <address className="not-italic space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col text-gray-300">
                  <a
                    href="tel:+9779745673009"
                    className="hover:text-white"
                    aria-label="Call +977-9745673009"
                  >
                    +977-9745673009
                  </a>
                  <a
                    href="tel:+9779700626667"
                    className="hover:text-white"
                    aria-label="Call +977-9700626667"
                  >
                    +977-9700626667
                  </a>
                </div>
          ...
          <section className="md:col-span-3 mt-1">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="bg-[#0069c0] text-white w-full py-3 px-4 rounded-md disabled:bg-gray-400 hover:bg-[#005BBB] transition-colors"
              >
