...
const Domain = () => {
    return (
        ...
        <section >
            ...
            <section>
                <div
                    className="flex flex-col lg:flex-row items-center justify-center  h-full  bg-gradient-to-r from-indigo-100 via-blue-0 to-white-200 relative overflow-hidden px-6 py-6 md:px-12 lg:px-32 "
                >
                    {/* Background Overlay */}
                    <div className="relative w-[80vw] py-2 h-full mb-10 md:mt-16 flex flex-col lg:flex-row items-start justify-center gap-10 lg:gap-20">
                        ...
                        <section className="relative z-10 w-full lg:w-[60%] text-left px-6 lg:px-10">
                            <div className="lg:w-1/2 space-y-4">
                                ...
                                <p>Invest in a valuable, unforgettable domain name and make yourself stand out from the crowd.
            ...
            <section className='className="container w-[80vw]  mx-auto mt-32 mb-20 px-4 lg:px-20 items-center"'>
                <div className="relative mt-8 flex flex-col lg:flex-row items-center justify-center gap-10">
                    <div className="lg:w-1/2 space-y-4 text-center">
                        ...
                        <h2 className="text-3xl font-semibold text-gray-800">
                            Connect with us and lets build something <span className="text-[#144A9C]">together</span>
                        </h2>
                    </div>
            ...
            <section>
                <div
                    className="flex flex-col lg:flex-row items-center justify-center  h-full  bg-gradient-to-l from-indigo-100 via-blue-0 to-white-200 relative overflow-hidden px-6 py-6 md:px-12 lg:px-32 "
                >
                    {/* Background Overlay */}
                    <div className="relative w-[80vw] py-2 h-full mb-10 md:mt-16 flex flex-col lg:flex-row items-start justify-center gap-10 lg:gap-20">
