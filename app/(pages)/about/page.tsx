...
const Page = () => {
  return (
    <section className="container w-[80vw]  mx-auto mt-32 mb-20 px-4 lg:px-20">
      {/* Hero Section */}
      ...
      <div className="mt-20 text-center">
        <h2 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-6">
          <span className="text-[#144A9C]">Engineering the Future</span> with Innovative Solutions
        </h2>
      ...
      {/* Team Section */}
      <div className="mt-20">
        <h2 className="text-3xl lg:text-4xl font-bold text-gray-800 text-center mb-10">
